...
const HomePage = () => {
  return (
    <div className="relative flex justify-center items-center text-center text-white" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh' }}>
      ...
      <div className="relative z-10 flex flex-col items-center p-4 pt-24 pb-40">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold uppercase text-stroke">WIN 300,000 FCFA</h1>
        <h2 className="text-6xl sm:text-7xl md:text-8xl text-brand-gold font-black uppercase my-1 text-stroke">REGISTER NOW!</h2>
        <p className="text-base sm:text-lg text-gray-200">Free Registration | Voting at 100 FCFA per vote</p>
        
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mt-8">
          <Link to="/register" className="bg-brand-gold text-black font-bold py-3 px-8 rounded-md shadow-lg hover:brightness-110 transition">Register as an Artist</Link>
          <Link to="/vote" className="bg-brand-gold text-black font-bold py-3 px-8 rounded-md shadow-lg hover:brightness-110 transition">Vote now</Link>
        </div>
